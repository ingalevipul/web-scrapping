...
base_url="https://www.trustpilot.com/categories/financial_institution"
load_more_url="?page="
info_list=[]
...
for i in range(1,26):
    ...
    body_click=driver.find_element(By.TAG_NAME,"body").click()
    btn_index=0
...
df.to_excel("Financail_insti_DATA.xlsx")   