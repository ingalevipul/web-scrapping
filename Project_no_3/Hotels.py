...
import requests
import time
path="C:\\Users\\Ankita\\Downloads\\chromedriver"
driver=webdriver.Chrome(path)
base_url="https://www.trustpilot.com/categories/doctors_surgeons"
load_more_url="?page="
info_list=[]
        ...
        if(btn_index<len(buttons)):
            ...
            if(i>4):
                driver.execute_script("window.scrollTo(0, window.scrollY + 170)")
                 ...
                 driver.execute_script("window.scrollTo(0, window.scrollY + 185)")
...
df.to_excel("Doctor_Surgeons_DATA.xlsx")   